...
POST requests sendes til /count-words-on-pages som returnerer antall ord på nettsidene som er ønsket.
...
Default er body elementet i htmlsiden. Formen på strengen må være en selector.
